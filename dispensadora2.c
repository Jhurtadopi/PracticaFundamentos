            ...
            if (venta == 'S')
            {
                ...
                do
                {
                    ...
                    if (monedaHoy.valor == moneda1.valor)
                    {
                        ...
                        {
                            dineroFaltante=dineroFaltante+(producto1.precio-ventaValor);
                            printf("Te hacen falta %i de monedas...\n", dineroFaltante);
                        }      
                    }

                    if (monedaHoy.valor == moneda2.valor)
                    {
                        printf("cuantas monedas de la cantidad (%i) vas a ingresar: ", monedaHoy.valor);
                    ...
                    if (monedaHoy.valor == moneda3.valor)
                    {
                        printf("cuantas monedas de la cantidad (%i) vas a ingresar: ", monedaHoy.valor);
                ...
                else if (ventaValor > producto1.precio)
                {
                    ...
                    {
                        moneda1.cantidad=devueltas/moneda1.valor;//cociente...
                        devueltas=devueltas%moneda1.valor;//residuo...
                        printf("Monedas de %i: %i\n", moneda1.valor, moneda1.cantidad);
                    }
                    if (devueltas>=moneda2.valor)
                    {
                        moneda2.cantidad=devueltas/moneda2.valor;
                        devueltas=devueltas%moneda2.valor;                       
                        printf("Monedas de %i: %i\n", moneda2.valor, moneda2.cantidad);
                    }
                    if (devueltas>=moneda3.valor)
                    {
                        moneda3.cantidad=devueltas/moneda3.valor;
                        devueltas=devueltas%moneda3.valor;
                    }
                    if (devueltas!= 0 && devueltas<moneda3.valor)//en clase...
                    {
                        moneda3.cantidad++;
                    }
                    if (moneda3.cantidad>0)
                    {
            ...
            if (venta == 'S')
            {
                do
                {
                    ...
                    if (monedaHoy.valor == moneda1.valor)
                    {
                        ...
                        if (ventaValor < producto1.precio)
                        {
                            dineroFaltante=dineroFaltante+(producto2.precio-ventaValor);
                            printf("Te hacen falta %i de monedas...\n", dineroFaltante);
                        }      
                    }
                ...
                { 
                    ...
                    if (devueltas>=moneda1.valor)
                    {
                        ...
                        devueltas=devueltas%moneda1.valor;
                    }
            ...
            if (venta == 'S')
            {
                do
                {
                    ...
                    if (monedaHoy.valor == moneda1.valor)
                    {
                        ...
                        {
                            dineroFaltante=dineroFaltante+(producto3.precio-ventaValor);
                            printf("Te hacen falta %i de monedas...\n", dineroFaltante);
                        }      
                    }
